                ...
                <div class="col-4 p-0" style="height: 100%;">
                    <div class="px-4">
                        <div class="d-flex align-items-center">
                            ...
                            {
                                (post.user.profile.user_id != auth().user().id) ?
                    ...
                    <div class="d-flex flex-column justify-content-between">
                        ...
                        <div class="px-4" style="width: 100%;">
                            ...
                            <form class="d-flex align-items-baseline justify-content-between" action="/comments/create/{{ $post->id }}" enctype="multipart/form-data" method="post">
                                {/* @csrf */}
                                <input class="bg-body text-primary border-0" style="border:none; " id="comment" type="text" className="form-control @error('comment') is-invalid @enderror" name="comment" value="{{ old('comment') }}" autocomplete="comment" placeholder="Add a comment..." autofocus />
