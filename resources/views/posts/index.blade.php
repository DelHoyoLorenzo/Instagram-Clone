        ...
        @foreach($posts as $post)
            ...
            <div class="col-6 offset-2 py-2">
                ...
                <div class="d-flex gap-3 my-2">
                    <div style="cursor: pointer;" id="LikeButton" class="like-button" liked={{ $post->likes }} post_id={{ $post->id }} user_id={{ $user->id }} key={{ $post->id }} ></div>
                    <a href="/p/{{ $post->id }}">
                ...
                <div class="d-flex align-items-baseline gap-2">
                    <p class="fw-bold">{{ $post->likes->count() }}</p>
