...
<div {{ $attributes }}>
    ...
    @if(true)
    <div {{ $likePost($attributes['post_id']) }}>
...
<script>
    /* function likePost(postId , userId) {
        ...
        fetch(`/like/${postId}`, {
            ...
            // You can pass additional data in the request body if required
            body: JSON.stringify({
